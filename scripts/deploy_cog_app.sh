...
ensure_command "yq" "sudo curl -L https://github.com/mikefarah/yq/releases/latest/download/yq_$(uname -s)_$(uname -m | sed 's/x86_64/amd64/') -o /usr/local/bin/yq && sudo chmod +x /usr/local/bin/yq"
